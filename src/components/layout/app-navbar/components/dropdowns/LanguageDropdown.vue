<template>
    <div class="language-dropdown">
        <span class="flag-icon flag-icon-large" :class="flagIconClass(currentLanguage())"/>
        <vuestic-dropdown class="language-dropdown__container" v-model="isShown" position="bottom">
            <a class="dropdown-item" v-for="(option, id) in options"
               :key="id"
